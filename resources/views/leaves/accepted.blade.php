            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">List of Accepted</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">List of Accepted Leaves</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-actions text-right">
                                            <a style="margin-right: 20%;" class="btn btn-secondary btn-sm" href="{{route('leave-view', ['id'=>$model->id])}}">
                                                <i class="fas fa-eye">
                                                </i>
                                            </a>
